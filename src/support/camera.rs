...
impl CameraState {
    ...
    pub fn update(&mut self) {
        ...
        if self.moving_up {
            self.position.0 += u.0 * 0.1;
            self.position.1 += u.1 * 0.1;
            self.position.2 += u.2 * 0.1;
        }

        if self.moving_left {
            self.position.0 -= s.0 * 0.1;
            self.position.1 -= s.1 * 0.1;
            self.position.2 -= s.2 * 0.1;
        }
        ...
        if self.moving_forward {
            self.position.0 += f.0 * 0.1;
            self.position.1 += f.1 * 0.1;
            self.position.2 += f.2 * 0.1;
        }
